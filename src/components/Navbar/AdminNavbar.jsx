...
import { BarChart3, LayoutDashboard, Menu, ShieldCheck, Users2 } from "lucide-react";
      ...
      <div className="container mx-auto px-6">
        <div className="flex h-18 items-center justify-between gap-4 py-3">
          ...
          <nav className="hidden items-center gap-2 rounded-full border border-amber-100 bg-white/80 p-1.5 shadow-sm md:flex">
            ...
            <NavLink to="/admin-vendors" className={navItemClass}>Vendors</NavLink>
            <NavLink to="/admin-inquiries" className={navItemClass}>Inquiries</NavLink>
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="bg-white">
                <div className="mt-8 flex flex-col gap-5 text-base font-medium text-slate-700">
                  <Link to="/admin-dashboard" className="hover:text-amber-500">Dashboard</Link>
                  <Link to="/admin-vendors" className="hover:text-amber-500">Vendors</Link>
                  <Link to="/admin-inquiries" className="hover:text-amber-500">Inquiries</Link>
                  <Link to="/admin-users" className="hover:text-amber-500">Users</Link>
