            ...
            <div className="p-8 sm:p-10 lg:p-12">
              <div className="mx-auto max-w-md">
                <div className="mb-8">
                  ...
                  <h2 className="mt-2 text-3xl font-bold text-slate-900">Vendor login</h2>
                </div>
                ...
                <div className="mt-6 space-y-3 text-center text-sm text-slate-600">
                  <p>
                    Want to join?{' '}
                    <Link to="/vendor-register" className="font-semibold text-amber-600 hover:text-amber-500">
                      Create a vendor account
                    </Link>
                  </p>
                  <p>
                    Demo flow:{' '}
                    <Link to="/vendor-admin" className="font-semibold text-amber-600 hover:text-amber-500">
