      ...
      <div className="bg-gradient-to-b from-amber-50 via-white to-orange-50 pb-16">
        <div className="container mx-auto px-6 py-10 md:py-12">
          <div className="rounded-[2rem] border border-amber-100 bg-white p-8 shadow-[0_16px_40px_rgba(15,23,42,0.04)] md:p-10">
            ...
            <h1 className="mt-3 text-4xl font-bold tracking-tight text-slate-900">Service provider management</h1>
            <p className="mt-4 max-w-2xl text-slate-600">Review service provider applications, manage approvals, and monitor service provider activity from one place.</p>

            <div className="mt-8 grid gap-5 md:grid-cols-3">
              <div className="rounded-[1.5rem] border border-amber-100 bg-amber-50/40 p-5">
                <p className="text-sm text-slate-500">Approved service providers</p>
