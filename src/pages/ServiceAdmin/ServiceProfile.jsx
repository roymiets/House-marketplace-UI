			...
			<MainLayout>
				<div className="container mx-auto px-6 py-16">
					<div className="rounded-[2rem] border border-dashed border-rose-200 bg-white p-12 text-center">
						...
						<p className="mt-3 text-slate-600">This profile does not exist yet in the service provider portal.</p>
					</div>
				</div>
			</MainLayout>
		);
					...
					<form className="mt-8 rounded-[2rem] border border-amber-100 bg-white p-6 shadow-[0_16px_40px_rgba(15,23,42,0.04)] md:p-8" onSubmit={handleSubmit}>
						<div className="grid gap-5 md:grid-cols-2">
							<div className="space-y-2">
								<label htmlFor="name" className="text-sm font-medium text-slate-700">Service provider name</label>
						...
						<div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
							<div className="inline-flex items-center gap-2 text-sm text-slate-500">
								<Sparkles className="h-4 w-4 text-amber-500" />
								Service provider profile is visible to buyers after approval.
							</div>
						...
						{saved ? (
							<div className="mt-5 rounded-[1rem] border border-emerald-100 bg-emerald-50 p-3 text-sm text-emerald-700">
								<div className="flex items-center gap-2">
									...
									Service provider profile saved successfully.
								</div>
							</div>
						) : null}
					</form>
